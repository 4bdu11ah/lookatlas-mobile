...
const directors = [
  Director(
    ...
    description: 'The industry standard for e-commerce. Crystal-clear product presentation with neutral backgrounds, even lighting, and poses that let the product speak for itself. Perfect for brands prioritizing clarity and conversion.',
    story: '''Alex spent a decade shooting for the world's most efficient e-commerce operations, from Uniqlo's Tokyo headquarters to Everlane's San Francisco studio. What he learned: the best product photography is invisible. It doesn't distract; it converts.
...
Now Alex brings that data-driven precision to every shoot. He's obsessed with the details that matter: perfect color accuracy, consistent shadows, poses that feel natural but show every seam. His images don't win photography awards, they win customers.''',
    philosophy: '''"The best product photo is one you don't notice. You just see the product clearly, trust it immediately, and click 'Add to Cart.'"''',
  ...
  Director(
    ...
    description: 'Quiet luxury meets timeless elegance. Soft, diffused lighting with muted tones creates an atmosphere of refined sophistication. For brands that whisper rather than shout.',
    story: '''Isabella grew up between her family's textile workshop in Como and the grand palazzos of Milan. She learned that true luxury isn't about logos, it's about light falling on cashmere, the weight of silk, the patina of leather.
...
Isabella's clients come to her when they want images that transcend seasons and trends. She creates photographs that could hang in a gallery or illustrate a family's heritage, timeless, understated, unforgettable.''',
    philosophy: '''"Luxury whispers. If you have to explain it, if it has to announce itself, it isn't luxury. The finest things in life reveal themselves slowly, in the right light."''',
    styleCharacteristics: [
    ...
    signature: 'The "inherited memory", images that feel like they belong in a family album from generations past',
  ...
  Director(
    ...
    description: 'High-octane fashion that demands attention. Sharp contrasts, powerful poses, and cinematic lighting create images that stop the scroll. For brands that want to make a statement.',
    story: '''Marcus cut his teeth on the nightclub photography circuit in São Paulo before catching the eye of a Balmain creative director at a fashion week afterparty. His raw, unpolished energy was exactly what high fashion needed, someone who wasn't afraid to break the rules.
...
Marcus doesn't photograph clothes, he creates moments of high drama. His subjects don't just wear fashion; they wield it like armor. When brands want images that stop thumbs mid-scroll and make hearts race, Marcus is the only call.''',
    philosophy: '''"Fashion should make you feel something. If your image doesn't stop someone in their tracks, make them gasp, make them want, what's the point? Play it safe on your own time."''',
    styleCharacteristics: [
  ...
  Director(
    ...
    description: 'Urban authenticity meets youthful energy. Candid moments, city backdrops, and an effortless cool that resonates with the social-first generation. Fast fashion meets street culture.',
    story: '''Jordan started documenting Seoul's underground fashion scene on a cracked iPhone, posting to a small but devoted following. Their raw, unfiltered approach caught fire, soon Zara and ASOS were sliding into DMs, desperate to capture that authentic street energy.
...
Jordan's secret weapon? They still shoot like no one's watching. No artifice, no pretension, just the electric energy of young people who know they look good and couldn't care less about proving it.''',
    philosophy: '''"Cool can't be manufactured. It happens when you're not trying, when the light hits right, when someone laughs for real. My job is to be there when it happens."''',
    styleCharacteristics: [
    ...
    signature: '''The "stolen moment", images that feel like the best frame from someone's real life''',
  ...
  Director(
    ...
    description: 'Less is more. Architectural precision, abundant negative space, and a monastic attention to form. For brands that believe in the power of restraint and thoughtful design.',
    story: '''Suki trained in traditional Japanese calligraphy before pivoting to fashion photography. The discipline stuck: every image is an exercise in ma, the Japanese concept of negative space as active presence, silence as communication.
...
Fashion houses from COS to Jil Sander trust Suki when they want images that transcend trends. Her work hangs in galleries alongside contemporary art. She doesn't capture fashion, she distills it to essence.''',
    philosophy: '''"In emptiness, everything speaks. Remove the unnecessary until only truth remains. A garment needs nothing but itself and the right light."''',
    styleCharacteristics: [
  ...
  Director(
    ...
    description: 'Sun-drenched authenticity and genuine moments. Warm, inviting imagery that feels like a perfect day with friends. For brands that celebrate real life and sustainable values.',
    story: '''Emma's photography career began on a sustainable fashion blog she started in college. What was supposed to document ethical brands became a visual language for an entire generation, golden hour everything, laughter over posed perfection, clothes that move with real bodies.
...
Brands like Reformation and Free People built their visual identity on Emma's influence. She doesn't just photograph clothes, she photographs the life those clothes are made for. Every image is an invitation to live more beautifully.''',
    philosophy: '''"The best moments aren't planned, they're caught. When the light is golden, the laugh is real, and the dress is dancing in the wind, that's when magic happens. My job is to be ready."''',
    styleCharacteristics: [
  ...
  Director(
    ...
    description: 'Precision-crafted luxury jewelry photography. Two-light setups for diamond brilliance, macro craftsmanship details, and on-hand lifestyle moments that sell engagement rings. Built for high-end jewelry ecommerce.',
    story: '''Natalie spent fifteen years as head photographer for a Parisian haute joaillerie house before going independent. She learned that photographing jewelry is nothing like photographing fashion, a ring is three grams of metal and stone that must look like a dream worth thousands.
...
What sets Natalie apart is her insistence on craftsmanship shots. While other jewelers photograph the diamond face, she gets in close, macro close, to show prong work, setting precision, and metal finishing. "Customers aren't just buying a diamond," she says. "They're buying the ring that holds it."''',
    philosophy: '''"A diamond has its own light, you don't create sparkle, you reveal it. One perfect accent light, the right angle, and suddenly a stone worth thousands looks like it's worth millions."''',
    styleCharacteristics: [
    ...
    signature: 'The "revealed brilliance", natural light that makes diamonds come alive with authentic fire',
...
Today Devon shoots between New York and Lisbon, refusing both the heritage-luxury register and the fast-fashion sparkle aesthetic. The work sits in the middle: luxury that feels real, jewelry that reads as something a real person could actually own and wear.''',
    philosophy: '''"A diamond doesn't need to dazzle to be desired. It needs to read as real. The eye trusts what looks honest under available light, sparkle is what you fall back on when the photography fails."''',
    styleCharacteristics: [
    ...
    signature: 'The "honest stone", diamonds and metals rendered with the optical authenticity of real photography, where brilliance is contrast between bright and dark facets, never added glow',
  ...
  Director(
    ...
    description: '''Elegant, modest children's & family footwear photography in the register of Bonpoint and Tartine et Chocolat, with a British-royal-children sensibility. Warm natural light, real-photography texture, and shoes and legs framed as tender little moments, never stiff catalog product shots. Built for modest kidswear and family brands.''',
    story: '''Beatrice Hartley photographed children for the great European children's houses for two decades before going independent, the kind of houses where a christening shoe is an heirloom and a catalog is expected to look like a family's own albums, not a storefront.
...
Her other obsession is restraint and modesty. Working closely with families who dress their children modestly, she built a way of shooting that is elegant and covered by design, knee-length, soft tights, nothing styled older than the child, and made it look like the most natural thing in the world. The result is warm, storybook, and unmistakably real: a little world you'd want to live inside, photographed as if it already exists.''',
    philosophy: '''"You don't pose a childhood, you wait for it. The shoe is the subject, but the moment is the photograph, and it should look like a memory, never a render."''',
    styleCharacteristics: [
    ...
    signature: '''The "heirloom moment", children's footwear shot like a warm family memory, modest and real, never AI-perfect''',
