...
part '../widgets/welcome_profile_controls.dart';
part '../widgets/welcome_profile_steps.dart';
part '../widgets/welcome_profile_worktable.dart';
...
class _WelcomeProfileScreenState extends ConsumerState<WelcomeProfileScreen> {
  ...
  Future<void> _finish({required bool skipped}) async {
    ...
    final result = await ref.read(completeWelcomeProfileUseCaseProvider)(
      userId: userId,
      profile: _draft,
      skipped: skipped,
      step: _step.index + 1,
    );
    if (!skipped && mounted && result.isErr) {
